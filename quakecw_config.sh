...
export PATH="$PROJECT/local/sqlite/bin:$PROJECT/bin:$PROJECT/local/rclone-v1.73.5-linux-amd64:$PROJECT/EMOD3D/tools:$GMT_DIR/bin:$GDAL_HOME/bin:$PROJECT/local/ffmpeg-git-20240629-amd64-static:$CW/Velocity-Model:$PROJECT/local/proj/bin:$PATH"
