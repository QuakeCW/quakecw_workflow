...
DROPBOX_FILES=(
    ...
    "https://www.dropbox.com/scl/fi/o3ygu8bcz7upv79lcmrqy/Obs_20220511.tar.gz?rlkey=h5vnfj2yk7h3b0wr0s7mh2xgr&st=8rjal811&dl=1"
)
...
EXTRACT_DIRS["Obs_20220511.tar.gz"]="$HOME"
...
if checkpoint_exists "STEP6_QUAKECW_PACKAGES"; then
    if ask_rerun "STEP6_QUAKECW_PACKAGES" "Install QuakeCW packages"; then
        ...
        uv pip install --no-build-isolation "${GIT_BASE}/Pre-processing.git@${RELEASE}.2"
